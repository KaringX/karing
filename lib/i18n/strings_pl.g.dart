...
class TranslationsPl with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get continueConnectConfirm => 'Czy chcesz kontynuować łączenie?';
...
class _Translations$SettingsScreen$pl implements Translations$SettingsScreen$en {
	...
	@override String get chainProxy => 'Proxy łańcuchowe';
	...
	@override String postProxyTips({required Object p}) => 'Dane->Serwer proxy[${p}]->Łańcuchowy serwer proxy[Wiele serwerów proxy: od góry do dołu]->Serwer docelowy';
	...
	@override String get tunRouteExclude => 'Wyklucz trasę';
	@override String get tunRouteExcludeTips => 'Ruch w wykluczonych zakresach adresów nie będzie już trafiał do TUN';
...
class _Translations$meta$pl implements Translations$meta$en {
	...
	@override String get removed => 'Usunięto';
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'SettingsScreen.chainProxy' => 'Proxy łańcuchowe',
			...
			'SettingsScreen.postProxyTips' => ({required Object p}) => 'Dane->Serwer proxy[${p}]->Łańcuchowy serwer proxy[Wiele serwerów proxy: od góry do dołu]->Serwer docelowy',
			...
			'SettingsScreen.tunRouteExclude' => 'Wyklucz trasę',
			'SettingsScreen.tunRouteExcludeTips' => 'Ruch w wykluczonych zakresach adresów nie będzie już trafiał do TUN',
			...
			'continueConnectConfirm' => 'Czy chcesz kontynuować łączenie?',
