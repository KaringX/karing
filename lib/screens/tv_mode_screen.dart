...
class TvModeScreen extends LasyRenderingStatefulWidget {
  static RouteSettings routSettings() {
    return const RouteSettings(name: "TvModeScreen");
  }

  final String nextText;
  const TvModeScreen({super.key, required this.nextText});

  @override
  State<TvModeScreen> createState() => _TvModeScreenState();
}

class _TvModeScreenState extends LasyRenderingState<TvModeScreen> {
