...
class ListRemoveScreen extends LasyRenderingStatefulWidget {
  static RouteSettings routSettings(String viewTag) {
    return RouteSettings(name: "ListRemoveScreen:$viewTag");
  }
  ...
  @override
  State<ListRemoveScreen> createState() => _ListRemoveScreenState();
}

class _ListRemoveScreenState extends LasyRenderingState<ListRemoveScreen> {
  @override
  void initState() {
    super.initState();
  }
